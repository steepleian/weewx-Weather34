...
if (isset($weewxapi)){
	...
	$weather["temp_avg"]                  = (is_numeric($weewxrt[123]) ? number_format($weewxrt[123],1) : "0"); // last 60 minutes
	...
	$et 								  = pow(10,$t);$e=6.112*$et*($weather["humidity"]/100);
	...
	if($windunit!=$weather["wind_units"]){
		if($windunit=='mph' && $weather["wind_units"]=='kts'){
			ktsTomph($weather,"wind_speed");ktsTomph($weather,"wind_speed2");
