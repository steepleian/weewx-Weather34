...
include_once('settings.php');include('w34CombinedData.php');header('Content-type: text/html; charset=utf-8');
	...
	####################################################################################################
if($theme==="dark"){$background1="rgba(11, 12, 12, 0.4)";$text1="silver";}
else if($theme==="light"){$background1="whitesmoke";$text1="black";}
?>
...
?> </title>
 ...
 <style>
 body{background-color:<?php echo $background1 ?>}  
...
.weather34darkbrowser[url]:after{content:attr(url);font-size:14px;text-align: center;position:absolute;left:0;right:0;top:0;padding:4px 15px;margin:11px 10px 0 auto;font-family:arial;height:20px;}
...
<body>
<?php $forecastime = filemtime ('jsondata/ds.txt');?>

<div class="weather34darkbrowser" style="color:<?php echo $text1 ?>;" url="Forecast For <?php echo $stationName ?>
<?php echo '&nbsp;';echo "Updated &nbsp;".date( $timeFormatShort, $forecastime);?>
  ">  
</div>
