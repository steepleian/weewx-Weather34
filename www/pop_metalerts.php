...
<p><main class="grid_3"><articlegraph class="alert-row-narrow" style="background-color:white; font-size:11px;"><img src="css/euicons/Noalert.svg" style="width:50px"><?php
...
?></articlegraph>
    ...
    <main class="grid3"><articlegraph3 class="alert-row-narrow" style="background-color:lightyellow; font-size:11px;"><img src="css/euicons/lightyellow_triangle.svg" style="width:50px"><?php
...
?></articlegraph3>
    ...
    <main class="grid3"><articlegraph3 class="alert-row-narrow" style="background-color:yellow; font-size:11px;"><img src="css/euicons/yellow_triangle.svg" style="width:50px"><?php
echo "Alert Level Moderate. The weather is potentially dangerous. The weather phenomena that have been forecast are not unusual, but be attentive if you intend to practice activities exposed to meteorological risks. Keep informed about the expected meteorological conditions and do not take any avoidable risk.";
?></articlegraph3>
    
    <main class="grid3"><articlegraph3 class="alert-row-narrow" style="background-color:orange; font-size:11px;"><img src="css/euicons/orange_triangle.svg" style="width:50px"><?php
echo "Alert Level Severe. The weather is dangerous. Unusual meteorological phenomena have been forecast. Damage and casualties are likely to happen. Be very vigilant and keep regularly informed about the detailed expected meteorological conditions. Be aware of the risks that might be unavoidable. Follow any advice given by your authorities.";
?></articlegraph3>
      
    <main class="grid3"><articlegraph3 class="alert-row-narrow" style="background-color:red; font-size:11px;"><img src="css/euicons/red_triangle.svg" style="width:50px"><?php
echo "Alert Level Extreme. The weather is very dangerous. Exceptionally intense meteorological phenomena have been forecast. Major damage and accidents are likely, in many cases with threat to life and limb, over a wide area. Keep frequently informed about detailed expected meteorological conditions and risks. Follow orders and any advice given by your authorities under all circumstances, be prepared for extraordinary measures.";
?></articlegraph3>
<?php                          
    break;  
