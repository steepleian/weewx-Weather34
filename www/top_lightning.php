...
<?php 
if ($windunit == 'mph'){echo "<spanfeelstitle>Last Distance At:<orange> " .number_format($lightningdistance*0.621371,1). "  </orange>miles";}
else  echo "<spanfeelstitle>Last Distance At:<orange> " .$lightningdistance. "  </orange>km";
?><br>

<?php
//weather34 weather34 last detect
echo "<spanfeelstitle>Alltime Strike Total: <orange> ".$lightning." </orange> ";?><br>  
  </div>
