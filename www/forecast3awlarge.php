...
$pngicon          = explode(".", ($parsed_json['response'][0]['periods'][0]['icon']));
$forecastIcon     = $pngicon[0];
...
echo '<img src="css/aerisicons/' . $forecastIcon . '.svg" width="50" height="40" alt="' . $forecastdesc . '" title="' . $forecastdesc . '"></img>';
