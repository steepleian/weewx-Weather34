...
Meteogram.prototype.getChartOptions = function () {
  return {
    ...
    title: {
      text: 'Meteogram for Steeple Claydon North End (UK)',
      align: 'left',
      style: {
        whiteSpace: 'nowrap',
...
if (!location.hash) {
  location.hash = 'https://api.met.no/weatherapi/locationforecast/2.0/compact?lat=51.940&lon=-0.987&altitude=84';
}
