...
<?php
if ($lightning_strike_count > 0){echo '<spanelightning><alertvalue><orange>Lightning Detected Near By Take Cover</orange><alertadvisory>'.$lightningalert2.'</alertadvisory>
