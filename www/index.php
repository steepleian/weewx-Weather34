...
<?php if ($position6=='forecast3ds.php' || ($dshourly=='yes' && $apikey!= '11111111111111' && ($position6=='forecast3wu.php' || $position6=='forecast3wularge.php'))) {echo '<a alt="Alerts" title="Alerts" href="darkskyalerts.php" data-lity>&nbsp;'. $chartinfo. " Alerts</a>";}?></span>
  ...
  <span class="yearpopup"> <a alt="nearby metar station" title="nearby metar station" href="metarnearby.php" data-lity><?php echo $chartinfo?> <?php echo 'Nearby Metar';?> <?php if(filesize('jsondata/me34.txt')<160){echo "(<ored>Offline</ored>)";}else echo "" ?></a></span>
